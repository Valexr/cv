...
- Разрабатываю компонент построения графиков трендов систем оборудования...
- Собрал спрайт иконок из шрифта и организовал фолбэк совместимость
- Начинал адаптацию GUI и UX к мобильным устройствам
